...
6. Click on Add Input and add the following attributes of appropriate type(string, number, and so on) and mark as required. The "Item" attribute should be mark also as list. As shown below.   
